  ...
  return (
    <nav style={baseNavbarStyle} ref={ref}>
      ...
      <div style={sectionStyle}>
        <span style={titleStyle}>Schema Editor</span>
        {['Export as JSON', 'Import JSON', 'Clear Graph'].map((text) => {
           // Disable Clear if clearing
           const isDisabled = (text === 'Clear Graph' && isClearing);
           let buttonText = text;
           if (text === 'Clear Graph' && isClearing) {

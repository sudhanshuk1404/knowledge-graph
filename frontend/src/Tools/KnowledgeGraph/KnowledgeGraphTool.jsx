    ...
    const loadGraphData = async () => {
      ...
      try {
        ...
        if (response.status === 503) {
          ...
          console.warn("Database connection unavailable - working in local mode");
          setGraphData({ nodes: [], links: [] }); // Start with empty graph
          setGraphLoadError("Database connection unavailable - working in local mode only");
        ...
        setGraphLoadError("Working in local mode - changes won't be saved to database");
